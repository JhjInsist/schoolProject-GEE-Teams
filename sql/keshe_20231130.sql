...
INSERT INTO `message` VALUES (6, '贾宏佳', 2, 1, '已加入你好啊队', '2023-11-30 22:24:53', '2023-11-30 22:24:53', 0, 0);
...
CREATE TABLE `school_message`  (
  ...
  `content` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '信息摘要',
...
CREATE TABLE `system_log`  (
  ...
  `behaviour` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '行为',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `interface` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '访问接口',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;
...
INSERT INTO `team_member` VALUES (8, 16, 2, '2023-11-30 22:24:53', '2023-11-30 22:24:53', 0);
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (1, 'root', '12345678', 'jhj_insist@outlool.com', '2023-03-15 00:32:07', '2023-11-15 23:33:10', 1, '贾宏佳', '大连工业大学', '男', '15324161007', '辽宁', NULL, NULL);
INSERT INTO `user` VALUES (2, 'jhj', '12345678', 'jhj_insist@outlool.com', '2023-03-15 00:32:07', '2023-11-15 23:33:10', 1, '贾宏佳', '大连工业大学', '男', '15324161007', '辽宁', NULL, NULL);
INSERT INTO `user` VALUES (8, 'lyt', 'www12345', '', '2023-11-23 00:46:17', '2023-11-23 00:46:17', 0, '路一桐', NULL, '女', '15324161008', 'beijing', 'qwe', NULL);
